...
[travis-badge]: https://travis-ci.org/filipesilva/angular-ngx-breadcrumbs.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-ngx-breadcrumbs
...
1. Create a project folder (you can call it `ngx-breadcrumbs` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-ngx-breadcrumbs.git
cd angular-ngx-breadcrumbs
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-ngx-breadcrumbs/archive/master.zip)
...
Use your editor to search the project for all instances of `ngx-breadcrumbs` and change it
